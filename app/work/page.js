...
const projects = [
  ...
  { img: '/projects/real5.png', alt: 'Hôtel & Spa de luxe' },
        ...
        <div className="w-full max-w-[1200px] flex flex-col items-center justify-center px-[10vw] sm:px-[10vw] lg:px-0 lg:mt-16 md:pl-20 lg:pl-0">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-6 lg:gap-8">
            {projects.map((project, index) => (
              <div 
                key={index}
                className="relative overflow-hidden rounded-3xl md:rounded-xl border border-white/10 group cursor-pointer aspect-[1/1] sm:aspect-[4/3] bg-[#0a0a0a] hover:border-aqua/40 transition-all duration-700 ease-out shadow-2xl hover:shadow-[0_10px_40px_rgba(0,255,255,0.1)] hover:-translate-y-2"
              >
                ...
                <div className="absolute inset-0 w-full h-full">
                  <Image 
                    ...
                    className="object-cover object-top transition-transform duration-1000 group-hover:scale-105 opacity-90 group-hover:opacity-100"
                  />
                </div>
